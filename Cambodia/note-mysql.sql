...
GRANT ALL   PRIVILEGES            ON `PETTYLOAN`.`user01_%` TO 'user01'@'%' IDENTIFIED BY 'Cambodia01';
GRANT ALL   PRIVILEGES            ON `PETTYLOAN`.`user01_1` TO 'user01'@'%' IDENTIFIED BY 'Cambodia01';

GRANT SELECT,INSERT,UPDATE,DELETE ON PETTYLOAN.Trades_02  TO 'user02'@'%' IDENTIFIED BY 'Cambodia02';
GRANT ALL   PRIVILEGES            ON PETTYLOAN.`user02_%` TO 'user02'@'%' IDENTIFIED BY 'Cambodia02';
