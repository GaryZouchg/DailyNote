...
cleos  push action eofsio setpriv '["eosio.msig", 1]' -p eosio@active
...
#转账
cleos transfer eosio user1 "10000.0000 SYS"
#查看产块几点
...
#         9.给节点投票
cleos  system voteproducer prods    producera producerb producerc
cleos  system listproducers
...
#给产块代理投票
cleos system voteproducer proxy user1 producera
